"""Protocol 0.5 reference-runner wiring.

Protocol 0.4 defines the General Task Market API. This module layers
reference-runner capability gating on top of the 0.4 implementation so the
bundled worker only bids on task/delivery combinations it can actually finish.
"""
